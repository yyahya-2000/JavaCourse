...
import sample.model.PhoneRegisterHolder;
    ...
    void saveEditBtnAction() {
        ...
        if (validator.checkRegisterDataValidation(editedPhoneRegister)) {
            if (validator.isValidForEdit(editedPhoneRegister)) {
                ...
                //updating the contact in the DB
                PhoneRegisterDAO.updateContact(
                        PhoneRegisterHolder.getInstance().getIdRegisterForEdit(),
                        editedPhoneRegister);
            }
        }
    }
