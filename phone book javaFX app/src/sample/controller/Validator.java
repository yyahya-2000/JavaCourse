...
final class Validator {
     ...
     */
    boolean checkRegisterDataValidation(PhoneRegister newPhoneRegister) {
     ...
     * false otherwise
     */
    boolean checkFileNameAndDir(String dir, String name) {
     ...
     * false otherwise
     */
    boolean containsBlockedCharacter(String st) {
        boolean found = false;
     ...
     */
    boolean isSaved(PhoneRegister newRegister) {
     ...
     */
    boolean isValidForEdit(PhoneRegister editedPhoneRegister) {
        boolean result = true;
        Searcher searcher = new Searcher();
